...
public class Main {
 ...
 //   private String filePath;
    ...
    public String toText() throws IOException {
        ...
        extractData = new PDFParser(new RandomAccessFile(file, "r")); // update for PDFBox V 2.0
    ...
    public static String readTxtFile() {
        String data = null;
        try {
            File txt = new File(Paths.get("").toAbsolutePath().toString() + "/fileName.txt");
    ...
    public static String setFilePath() {
        Path cwd = Paths.get("");
        return  cwd.toAbsolutePath().toString() + "/uploadedFile/" + readTxtFile() + ".pdf" ;
    }

    public static String createConvertedFile() {
        Path cwd = Paths.get("");
        return  cwd.toAbsolutePath().toString() + "/convertedFile/" + readTxtFile() + "_converted.txt" ;
    }
